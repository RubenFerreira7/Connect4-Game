...
//se válido constrói o tabuleiro de jogo
if (start === true) {
                    ...
                    if ((gameBoard[i + 1][j].color === piece.color && piece.color !== "black") &&
                        ...
                        if (piece.color === 'red') {
                            ...
                            for (let i = 0; i < arr.length; i++) {
                                const player = arr[i]
                                if (selectedOne === player.name) {

                                    player.rank = player.rank + 100
                                  
                                    player.wins++
                                    player.ratio=player.wins/player.games
                                    console.log(player.rank);

                                    localStorage.setItem("players", JSON.stringify(arr))
                                }
                                if (selectedTwo === player.name) {
                            ...
                            if (piece.color === 'yellow') {
                                ...
                                Swal.fire({
                                    title: 'Vitória',
                                    text: `${selectedTwo} venceu na vertical `,
                                    icon: 'warning',
                                    showCancelButton: true,
                                    confirmButtonColor: '#3085d6',
                                    cancelButtonColor: '#d33',
...
// verifica vencedor horizontalmente
                    ...
                    if ((gameBoard[i][j + 1].color === piece.color && piece.color !== "black") &&
                        ...
                        if (piece.color === 'red') {
                            ...
                            if (piece.color === 'yellow') {
                                ...
                                Swal.fire({
                                    title: 'Vitória',
                                    text: `${selectedTwo} venceu na horizontal `,
                                    icon: 'warning',
                                    showCancelButton: true,
                                    confirmButtonColor: '#3085d6',
                                    cancelButtonColor: '#d33',
                        ...
                        if ((gameBoard[i + 1][j + 1].color === piece.color && piece.color !== "black") &&
                            ...
                            if (piece.color === 'red') {
                                ...
                                if (piece.color === 'yellow') {
                                    ...
                                    Swal.fire({
                                        title: 'Vitória',
                                        text: `${selectedTwo} venceu na diagonal `,
                                        icon: 'warning',
                                        showCancelButton: true,
                                        confirmButtonColor: '#3085d6',
                                        cancelButtonColor: '#d33',
